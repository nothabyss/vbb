...
class Blockchain:
    ...
    def __init__(self, vote_activity_id, initiator_puk, max_nums, max_days, votefile_path):
        self.votefile_path = votefile_path
        self.add_genesis(vote_activity_id, initiator_puk, max_nums, max_days)
    ...
    def add_genesis(self, vote_activity_id, initiator_puk, max_nums, max_days):
        genesis = GenesisBlock(vote_activity_id, initiator_puk, max_nums, max_days)
        global maxb
        maxb = max_nums
